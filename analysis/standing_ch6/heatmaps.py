...
from analysis.standing_ch6.viz_common import BLUE_SEQUENTIAL, PRIMARY_TEXT, SECONDARY_TEXT
...
def plot_person_grid(manifest, person_id: str) -> None:
    ...
    fig.suptitle(f"{person_id}: CSI amplitude heatmap, every standing session", color=PRIMARY_TEXT)
